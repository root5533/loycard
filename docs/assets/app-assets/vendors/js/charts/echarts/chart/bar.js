define("echarts/chart/bar", ["require", "./base", "zrender/shape/Rectangle", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart"], function (e) { function t(e, t, n, a, o) { i.call(this, e, t, n, a, o), this.refresh(a); } var i = e("./base"), n = e("zrender/shape/Rectangle"); e("../component/axis"), e("../component/grid"), e("../component/dataZoom"); var a = e("../config"); a.bar = { zlevel: 0, z: 2, clickable: !0, legendHoverLink: !0, xAxisIndex: 0, yAxisIndex: 0, barMinHeight: 0, barGap: "30%", barCategoryGap: "20%", itemStyle: { normal: { barBorderColor: "#fff", barBorderRadius: 0, barBorderWidth: 0, label: { show: !1 } }, emphasis: { barBorderColor: "#fff", barBorderRadius: 0, barBorderWidth: 0, label: { show: !1 } } } }; var o = e("../util/ecData"), r = e("zrender/tool/util"), s = e("zrender/tool/color"); return t.prototype = { type: a.CHART_TYPE_BAR, _buildShape: function () { this._buildPosition(); }, _buildNormal: function (e, t, i, o, r) { for (var s, l, h, d, c, m, p, u, V, U, g, f, y = this.series, b = i[0][0], _ = y[b], x = "horizontal" == r, k = this.component.xAxis, v = this.component.yAxis, L = x ? k.getAxis(_.xAxisIndex) : v.getAxis(_.yAxisIndex), w = this._mapSize(L, i), W = w.gap, X = w.barGap, I = w.barWidthMap, S = w.barMaxWidthMap, K = w.barWidth, C = w.barMinHeightMap, T = w.interval, E = this.deepQuery([this.ecTheme, a], "island.r"), z = 0, A = t; A > z && null != L.getNameByIndex(z); z++) {
    ...
    } this._calculMarkMapXY(o, i, x ? "y" : "x"); }, _buildHorizontal: function (e, t, i, n) { return this._buildNormal(e, t, i, n, "horizontal"); }, _buildVertical: function (e, t, i, n) { return this._buildNormal(e, t, i, n, "vertical"); }, _buildOther: function (e, t, i, a) { for (var o = this.series, r = 0, s = i.length; s > r; r++)
        ...
        } this._calculMarkMapXY(a, i, "xy"); }, _mapSize: function (e, t, i) { var n, a, o = this._findSpecialBarSzie(t, i), r = o.barWidthMap, s = o.barMaxWidthMap, l = o.barMinHeightMap, h = o.sBarWidthCounter, d = o.sBarWidthTotal, c = o.barGap, m = o.barCategoryGap, p = 1; if (t.length != h) {
        if (i)
            n = e.getGap(), c = 0, a = +(n / t.length).toFixed(2), 0 >= a && (p = Math.floor(t.length / n), a = 1);
        else if (n = "string" == typeof m && m.match(/%$/) ? (e.getGap() * (100 - parseFloat(m)) / 100).toFixed(2) - 0 : e.getGap() - m, "string" == typeof c && c.match(/%$/) ? (c = parseFloat(c) / 100, a = +((n - d) / ((t.length - 1) * c + t.length - h)).toFixed(2), c = a * c) : (c = parseFloat(c), a = +((n - d - c * (t.length - 1)) / (t.length - h)).toFixed(2)), 0 >= a)
            return this._mapSize(e, t, !0);
    }
    else if (n = h > 1 ? "string" == typeof m && m.match(/%$/) ? +(e.getGap() * (100 - parseFloat(m)) / 100).toFixed(2) : e.getGap() - m : d, a = 0, c = h > 1 ? +((n - d) / (h - 1)).toFixed(2) : 0, 0 > c)
        return this._mapSize(e, t, !0); return this._recheckBarMaxWidth(t, r, s, l, n, a, c, p); }, _findSpecialBarSzie: function (e, t) { for (var i, n, a, o, r = this.series, s = {}, l = {}, h = {}, d = 0, c = 0, m = 0, p = e.length; p > m; m++)
        ...
        if ("insideLeft" === k || "insideRight" === k || "insideTop" === k || "insideBottom" === k) {
            ...
            switch (k) {
                ...
                case "insideTop":
                    ...
                    break;
                case "insideBottom": b[_].textX = y.x + y.width / 2, b[_].textY = y.y + y.height - v / 2, b[_].textAlign = "center", b[_].textBaseline = "bottom";
            }
            b[_].textPosition = "specific", b[_].textColor = b[_].textColor || "#fff";
        }
    } return this.deepQuery([p, m, this.option], "calculable") && (this.setCalculable(d), d.draggable = !0), o.pack(d, c[e], e, c[e].data[t], t, i), d; }, getMarkCoord: function (e, t) { var i, n, a = this.series[e], o = this.xMarkMap[e], r = this.component.xAxis.getAxis(a.xAxisIndex), s = this.component.yAxis.getAxis(a.yAxisIndex); if (!t.type || "max" !== t.type && "min" !== t.type && "average" !== t.type)
        if (o.isHorizontal) {
    ...
    } return n; }, refresh: function (e) { e && (this.option = e, this.series = e.series), this.backupShapeList(), this._buildShape(); }, addDataAnimation: function (e, t) { function i() { V--, 0 === V && t && t(); } for (var n = this.series, a = {}, r = 0, s = e.length; s > r; r++)
        a[e[r][0]] = e[r]; for (var l, h, d, c, m, p, u, V = 0, r = this.shapeList.length - 1; r >= 0; r--)
        ...
        } V || t && t(); } }, r.inherits(t, i), e("../chart").define("bar", t), t; });
