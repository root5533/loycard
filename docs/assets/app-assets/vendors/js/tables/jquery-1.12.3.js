...
(function (global, factory) {
    ...
    function getAll(context, tag) {
        var elems, elem, i = 0, found = typeof context.getElementsByTagName !== "undefined" ?
    ...
    rdisplayswap = /^(none|table(?!-c[ea]).+)/, rnumsplit = new RegExp("^(" + pnum + ")(.*)$", "i"), cssShow = { position: "absolute", visibility: "hidden", display: "block" }, cssNormalTransform = {
        letterSpacing: "0",
        fontWeight: "400"
        ...
        jQuery.cssHooks[name] = {
            ...
            set: function (elem, value, extra) {
                ...
                return setPositiveNumber(elem, value, extra ?
                    augmentWidthOrHeight(elem, name, extra, support.boxSizing &&
        ...
        toggleClass: function (value, stateVal) {
            ...
            return this.each(function () {
                ...
                if (type === "string") {
                    ...
                    jQuery.attr(this, "class", className || value === false ?
                        "" :
