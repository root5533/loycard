...
(function ($) {
    ...
    $.fn.slidingMenu = function (options) {
        ...
        return this.each(function () {
            ...
            $('a', self).on('click', function (e) {
                ...
                if (href == '#') {
                    ...
                    var target = $(href), isBack = $(this).hasClass('back'), marginLeft, marginRight;
                    if (rtl === true) {
        ...
        function process(data) {
            ...
            $(ul).each(function (index, item) {
                ...
                if (index == 0) {
                    ...
                    panel.addClass('menu-panel');
                    var li = $('<li></li>'), back = $('<a></a>').addClass('nav-has-parent back primary dropdown-item').attr('href', '#menu-panel-back');
                    panel.prepend(back);
                }
                panels.push(item);
            });
        ...
        function updateWidth() {
            var wrapper = $('.sliding-menu-wrapper'), menuPanels = $('.sliding-menu-wrapper ul');
