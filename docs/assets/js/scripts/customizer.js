...
(function (window, document, $) {
    ...
    *           Layout Options          *
    ************************************/
    var body = $('body'), header_navbar = $('nav.header-navbar'), horz_header_navbar = $('div.header-navbar'), footer = $('footer'), menu = $('.main-menu'), menu_type = body.data('menu'), horz_layout = false, semiLight = false, semiDark = false;
    ...
    ****************************************/
    ...
    $('.customizer-sidebar-options .btn').on('click', function () {
        var $this = $(this), sidebarColor = $this.attr('data-sidebar');
    ...
    *           Color Options        *
    *********************************/
    var el = $('nav.header-navbar'), nav_type = 'navbar-semi-light', bgClass = '';
