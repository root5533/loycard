            ...
            series: [
                {
                    ...
                    itemStyle: {
                        ...
                        color: (function () {
                            ...
                            return zrColor.getLinearGradient(0, 400, 0, 300, [[0, 'green'], [1, 'yellow']]);
                        })(),
                        emphasis: {
                            barBorderWidth: 5,
                            ...
                            color: (function () {
                                var zrColor = require('zrender/tool/color');
                                return zrColor.getLinearGradient(0, 400, 0, 300, [[0, 'red'], [1, 'orange']]);
                            })(),
                            label: {
                                show: true,
                                position: 'top',
                ...
                },
                {
                    ...
                    itemStyle: {
                        normal: {
                            ...
                            color: (function () {
                                var zrColor = require('zrender/tool/color');
                                return zrColor.getLinearGradient(0, 0, 1000, 0, [[0, 'rgba(30,144,255,0.8)'], [1, 'rgba(138,43,226,0.8)']]);
                            })(),
                            label: {
                                show: true,
                                textStyle: {
